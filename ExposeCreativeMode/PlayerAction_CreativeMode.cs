...
{
    public class PlayerAction_CreativeMode : PlayerAction_Test
    {
        ...
        const int debounceControlCount = 1;
        bool[] debounceControl = new bool[debounceControlCount];
